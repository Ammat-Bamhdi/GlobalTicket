...
public class GlobalTicketDbContext(DbContextOptions<GlobalTicketDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // The hasData checks if the data provided is exist, 
        // otherwise it insets it
